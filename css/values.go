...
// namedSizes maps CSS named font sizes to pixel values.
// CSS 2.1 §15.7: Named sizes
// Defined at package level to avoid recreating on every ParseFontSize call.
...
// CSS 2.1 §4.3.6: Named colors (17 basic colors)
// CSS Color Module Level 3: Extended color keywords (147 total)
// Defined at package level to avoid recreating on every ParseColor call.
...
func ParseFontSize(value string) float64 {
	...
	// CSS 2.1 §15.7: Named sizes (uses package-level namedSizes map)
...
func ParseColor(value string) color.RGBA {
	...
	// CSS 2.1 §4.3.6: Named colors (uses package-level namedColors map)
